...
if IKAI then
	...
	function library:Window(text,text2,text3,logo,keybind)
		...
		Uitoggle.Name = "x2switz 2.0"
		Uitoggle.Parent = x2switz 2.0FrameUi
...
General_Tab:Dropdown("FastAttack","Extreme",MIo,function(vu)
	...
	elseif _G.Setting_table.FastAttack_Mode == "Extreme" then
		_G.Fast_Delay = 0.000000000000000000000000000
	end
end)
                        ...
                        if _G.Lv_Ken >= 5000 then
                            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CitizenQuestProgress","Citizen") == 3 then
                                ...
                                if not game.Players.LocalPlayer.Backpack:FindFirstChild("Pineapple") and not game.Players.LocalPlayer.Character:FindFirstChild("Pineapple") then
                                    ...
                                    if not GPIJdz then
                                        Text("wait Fruit Spawn\nเธฃเธญเธเธฅเนเธกเนเน€เธเธดเธ”")
                                        GPIJdz = true
                                    end
		...
		pcall(function()
			if Auto_Three_World then
					...
					if game:GetService("Workspace").Enemies:FindFirstChild("rip_indra [Lv. 1500] [Boss]") then
						for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
							if v.Name == "rip_indra [Lv. 1500] [Boss]" and v.Humanoid.Health > 0 then
								...
								if not YUHJO then
									Text("เธ—เธณเน€เธเธงเธชเนเธฅเธ 3 เน€เธชเธฃเนเธเธชเธดเนเธ")
									YUHJO = true
								end
							end
						end
				...
				elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					if not IJOIJD then
						Text("เธเธธเธ“เธ—เธณเน€เธเธงเธชเนเธฅเธ 3 เน€เธชเธฃเนเธเนเธฅเนเธง")
						IJOIJD = true
					end
				else
					if not JUO then
						Text("เธเธธเธ“เธขเธฑเธเนเธกเนเน€เธเธดเธ”เธเธฃเธฐเธ•เธนเนเธ”เธเธฒ\nเนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธ—เธณเนเธ”เน!!")
						JUO = true
					end
				end
			else
...
function Raid_FG()
	...
	elseif not _G.Have_Fruit then
		Text("เนเธกเนเธกเธตเธเธฅเธเธตเธจเธฒเธเน€เธซเธฅเธทเธญ\nเนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธฅเธเธ”เธฑเธเนเธ”เน")
	end
end
spawn(function()
	while wait(.5) do
				...
				if not Mix_Farm or Auto_Phoenix_Awaken_Ex then
					if game.Players.LocalPlayer.Character:FindFirstChild("Bird-Bird: Phoenix") or game.Players.LocalPlayer.Backpack:FindFirstChild("Bird-Bird: Phoenix") then
						if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SickScientist","Check") ~= false then
							if not UHuHI then
								Text("เธเธณเธฅเธฑเธเธเธฒเธกเธกเธฒเธชเน€เธ•เธญเธฃเธตเนเธเธฅเธเธตเธจเธฒเธ")
								UHuHI = true
							end
							Auto_Farm_Fruit = true
								...
								if FG >= 6000 then
									...
									if _G.Have_Fruit then
										if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc", "Select", "Bird: Phoenix") == 1 then
											...
											Text("เธเธณเธฅเธฑเธเธฅเธเธ”เธฑเธเธเธตเธเธดเธเธ•เธทเนเธ")
											repeat wait(1)
										...
										elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc", "Select", "Bird: Phoenix") == '[You already have a Special Microchip.]' then
											...
											Auto_Raid = true
											TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(0,30,0))
											Text("เธเธณเธฅเธฑเธเธฅเธเธ”เธฑเธเธซเธฒเน€เธเธดเธเธกเนเธงเธ")
											repeat wait(1)
											until game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true
											repeat wait(1)
											until game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == false
										...
										elseif _G.Setting_table.Phoenix_Hop then
											if not UHIkx then
												Text("เธฃเธญ2เธ.เธกเธ–เธถเธเธเธฐเธเธทเนเธญเธเธดเธเธฅเธเธ”เธฑเธเนเธ”เน\nเธเธฒเธกเน€เธเธดเธเธกเนเธงเธเธฃเธญเธ”เธตเธเธงเนเธฒ")
												UHIkx = true
											end
											_G.Phoenix_R = true
											Raid_FG()
									...
									elseif Auto_Phoenix_Awaken_Ex then
										...
										Text("เธเธณเธฅเธฑเธเธเธฒเธกเน€เธเธดเธเนเธซเนเธ–เธถเธ 1เธฅเนเธฒเธ\nเน€เธเธทเนเธญเธเธทเนเธญเธเธดเธเธฅเธเธ”เธฑเธเธเธตเธเธดเธ")
										wait(10)
									end
								elseif Auto_Phoenix_Awaken_Ex then
									Auto_Phoenix_Awaken_Ex = nil
									...
									_G.Phoenix_R = true
									Raid_FG()
									Text("เน€เธเธดเธเธกเนเธงเธเนเธกเนเธ–เธถเธ 6000\nเนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธฅเธเธ”เธฑเธเนเธ”เน")
									Text("เธเธณเธฅเธฑเธเธซเธฒเธเธฅเธกเธฒเธฅเธเธ”เธฑเธ!")
									wait(10)
								end
							elseif FG < 1500 then
								if not LPOJO then
									Text("เน€เธเธดเธเธกเนเธงเธเนเธกเนเธ–เธถเธ 1500\nเนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธ—เธณเน€เธเธงเธชเนเธ”เน")
									Text("เธเธณเธฅเธฑเธเธซเธฒเธเธฅเธกเธฒเธฅเธเธ”เธฑเธ!")
									LPOJO = true
								end
								_G.Phoenix_R = true
		...
		pcall(function()
			if _G.Setting_table.Mink_Evo and not _G.Setting_table.Mink_Evo_H and game.Players.LocalPlayer.Data.Race.Value == 'Mink' then
				...
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
						if not UIhjdk then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเธกเธดเธเธเนเธงเธต 1")
							UIhjdk = true
						end
						pcall(function()
						...
						if not game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 1") and not game.Players.LocalPlayer.Character:FindFirstChild("Flower 1") and game:GetService("Workspace"):FindFirstChild("Flower1") then
							if not YUIk then
								Text("เธเธณเธฅเธฑเธเธซเธฒ เธ”เธญเธเนเธกเนเธเนเธณเน€เธเธดเธ")
								YUIk = true
							end
							repeat wait(1)
						...
						elseif not game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 2") and not game.Players.LocalPlayer.Character:FindFirstChild("Flower 2") and game:GetService("Workspace"):FindFirstChild("Flower2") then
							if not YUIkx then
								Text("เธเธณเธฅเธฑเธเธซเธฒ เธ”เธญเธเนเธกเนเนเธ”เธ")
								YUIkx = true
							end
							repeat wait(1)
						...
						elseif not game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 3") and not game.Players.LocalPlayer.Character:FindFirstChild("Flower 3") then
							if PO == nil then
								Text("เธเธณเธฅเธฑเธเธซเธฒ เธ”เธญเธเนเธกเนเน€เธซเธฅเธทเธญเธ")
								PO = true
							end
						...
						elseif game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 3") and game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 1") and game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 2") then
							...
							if not UHuit then
								Text("เธฃเธญเธ”เธญเธเนเธกเนเน€เธเธดเธ”")
								TP2(CFrame.new(-379.70889282227, 73.0458984375, 304.84692382813))
								UHuit = true
							end
							wait(2)
					...
					elseif _G.Setting_table.Mink_Evo_V2 ~= true then
						if not UIjfiz then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเธกเธดเธเธเนเธงเธต 2")
							UIjfiz = true
						end
						...
						elseif game.ReplicatedStorage:FindFirstChild("Don Swan [Lv. 1000] [Boss]") then
							...
							Text("เธฃเธญเธเธญเธชเนเธ”เธเธฒเน€เธเธดเธ”")
					...
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") ~= -2 then
						if not UIjfi then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเธกเธดเธเธเนเธงเธต 3")
							UIjfi = true
						end
					...
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") == -2 then
						if not IUHidm then
							Text("เธ—เธณเน€เธเนเธฒเธกเธดเธเธเนเธงเธต 3 เน€เธชเธฃเนเธเธชเธดเนเธ!")
							IUHidm = true
						end
					...
					Text("เธเธฃเธฐเธ•เธนเนเธ”เธเธฒเธขเธฑเธเนเธกเนเน€เธเธดเธ”\nเนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธ—เธณเน€เธเนเธฒเนเธ”เน")
					wait(5)
				end
			elseif _G.Setting_table.Human_Evo and not _G.Setting_table.Human_Evo_H and game.Players.LocalPlayer.Data.Race.Value == 'Human' then
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
						if not UIhjdkh then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเธเธเธงเธต 1")
							UIhjdkh = true
						end
						pcall(function()
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1")
					...
					elseif _G.Setting_table.Human_Evo_V2 ~= true then
						if not UIjfize then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเธเธเธงเธต 2")
							UIjfize = true
						end
						if game.Workspace.Enemies:FindFirstChild("Don Swan [Lv. 1000] [Boss]") then
							repeat wait(_G.Fast_Delay)
					...
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") ~= -2 then
						if not UIjfie then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเธเธเธงเธต 3")
							UIjfie = true
						end
						if not ijoijofdga then
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1")
						...
						elseif game.ReplicatedStorage:FindFirstChild("Diamond [Lv. 750] [Boss]") then
							...
							Text("เธฃเธญเธเธญเธชเน€เธเธดเธ” 5 - 15เธเธฒเธ—เธต")
							wait(10)
						end
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") == -2 then
						if not IUHidmr then
							Text("เธ—เธณเน€เธเนเธฒเธเธเธงเธต 3 เน€เธชเธฃเนเธเธชเธดเนเธ!")
							IUHidmr = true
						end
						if _G.Setting_table.Next_Race then
							_G.Setting_table.Human_Evo_H = true
				...
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
						if not UIhjdkhz then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเธเธตเธเธงเธต 1")
							UIhjdkhz = true
						end
						pcall(function()
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1")
					...
					elseif _G.Setting_table.Skypiea_Evo_V2 ~= true then
						if not UIjfizez then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเธเธตเธเธงเธต 2")
							UIjfizez = true
						end
						if game.Workspace.Enemies:FindFirstChild("Don Swan [Lv. 1000] [Boss]") then
							repeat wait(_G.Fast_Delay)
					...
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") ~= -2 then
						if not UIjfiez then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเธเธตเธเธงเธต 3")
							UIjfiez = true
						end
						if not ijoijofdga then
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1")
						...
						elseif _G.Setting_table.Race_Hop then
							Text("เนเธกเนเธกเธตเธเธเธ—เธตเนเธกเธตเน€เธเนเธฒเธชเธเธฒเธขเน€เธเธตเธข\nเนเธเนเธฅเธเธเธตเนเน€เธฅเธข")
							HopServer()
							wait(50)
						else
							Text("เนเธกเนเธกเธตเธเธเธ—เธตเนเธกเธตเน€เธเนเธฒเธชเธเธฒเธขเน€เธเธตเธข\nเนเธเนเธฅเธเธเธตเนเน€เธฅเธข")
					...
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") == -2 then
						if not IUHidmrz then
							Text("เธ—เธณเน€เธเนเธฒเธเธตเธเธงเธต 3 เน€เธชเธฃเนเธเธชเธดเนเธ!")
							IUHidmrz = true
						end
						if _G.Setting_table.Next_Race then
							_G.Setting_table.Skypiea_Evo_H = true
				...
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
						if not UIhjdkhzt then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเน€เธเธทเธญเธเธงเธต 1")
							UIhjdkhzt = true
						end
						pcall(function()
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1")
					...
					elseif _G.Setting_table.Fishman_Evo_V2 ~= true then
						if not UIjfizezt then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเน€เธเธทเธญเธเธงเธต 2")
							UIjfizezt = true
						end
						if game.Workspace.Enemies:FindFirstChild("Don Swan [Lv. 1000] [Boss]") then
							repeat wait(_G.Fast_Delay)
					...
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") ~= -2 then
						if not UIjfiezt then
							Text("เธเธณเธฅเธฑเธเธ—เธณเน€เธเนเธฒเน€เธเธทเธญเธเธงเธต 3")
							UIjfiezt = true
						end
						...
						Text("เน€เธเนเธฒเธ—เธฐเน€เธฅเธขเธฑเธเนเธกเนเน€เธเธดเธ”")
					...
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") == -2 then
						if not IUHidmrzt then
							Text("เธ—เธณเน€เธเนเธฒเน€เธเธทเธญเธเธงเธต 3 เน€เธชเธฃเนเธเธชเธดเนเธ!")
							IUHidmrzt = true
						end
						if _G.Setting_table.Next_Race then
							_G.Setting_table.Fishman_Evo_H = true
			...
			elseif _G.Setting_table.Mink_Evo_H and _G.Setting_table.Fishman_Evo_H and _G.Setting_table.Skypiea_Evo_H and _G.Setting_table.Human_Evo_H then
				Text("เธญเธตเนเธงเน€เธเนเธฒเธเธฑเนเธ 3 เธเธฃเธเธ—เธฑเนเธ4เน€เธเนเธฒเนเธฅเนเธง")
				wait(10)
			else
				wait(2)
			end
            ...
            if Triple_A then
                ...
                elseif _G.Setting_table.Triple_Hop then
					...
					if Beli < 2000000 then
						Text("เธเธฒเธกเน€เธเธดเธเธฃเธญเธ”เธฒเธเน€เธเธดเธ”")
						Auto_Farm_Sword = true
						wait(10)
					else
						Text("เธเธณเธฅเธฑเธเธซเธฒเธ”เธฒเธ")
						wait(10)
						HopServer()
						wait(50)
					end
				...
				if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == false then
					if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip") then
						...
						elseif Auto_Raid_Farm and not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") and not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip") then
							...
							_G.Stop_Tween = nil
							Auto_Raid_Farm = nil
							Text("เนเธกเนเธกเธตเธเธฅเธเธตเธจเธฒเธเน€เธซเธฅเธทเธญเนเธฅเนเธง")
						end
					end
				elseif game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
					repeat wait(1)
...
function HopServer()
    if not _G.TP_Ser then
		...
		game.StarterGui:SetCore("SendNotification", {
			...
			Text = "เธเธณเธฅเธฑเธเธซเธฒเน€เธเธดเธ",
			Icon = "http://www.roblox.com/asset/?id=9606070311",
			Duration = 25
		})
		local PlaceID = game.PlaceId
...
local Bartlio_ST = Status_Tab:LabelP("โ : Quest Bartlio")
local Open_Don_Swan_ST = Status_Tab:LabelP("โ : Quest Open Don Swan")
local Phoenix_Awaken_ST = Status_Tab:LabelP("โ : Quest Phoenix Awaken")
local Observation_Haki_ST = Status_Tab:LabelP("โ : Quest Observation Haki")
local Observation_Haki_V2_ST = Status_Tab:LabelP("โ : Quest Observation Haki V2")
Status_Tab:Label("Status Legendary Sword")
local ST_Shisui = Status_Tab:LabelP("โ : Shisui")
local ST_Saddi = Status_Tab:LabelP("โ : Saddi")
local ST_Wando = Status_Tab:LabelP("โ : Wando")
function CheckStatus()
	...
	if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
		Open_Don_Swan_ST:Set("โ… : Open Don Swan Quest")
	end
	if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 3 then
		Bartlio_ST:Set("โ… : Bartilo Quest") 
	end
	if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SickScientist","Heal") == 1 then
		Phoenix_Awaken_ST:Set('โ… : Quest Phoenix Awaken')
	end
	if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress","SickMan") == 0 then
		Observation_Haki_ST:Set('โ… : Quest Observation Haki')
	end
	if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CitizenQuestProgress","Citizen") == 3 then
		Observation_Haki_V2_ST:Set('โ… : Quest Observation Haki V2')
	end
	...
	for i,x in pairs(I_W) do
		...
		if v.Name == "Shisui" then
			ST_Shisui:Set("โ… : Shisui")
		end
		if v.Name == "Wando" then
			ST_Wando:Set("โ… : Wando")
		end
		if v.Name == "Saddi" then
			ST_Saddi:Set("โ… : Saddi")
		end
	end
	for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
		if v:IsA("Tool") then
